...
async function fetchNews(query, date = null) {
...
const picker = new Pikaday({
    ...
    onSelect: function(date) {
        const formattedDate = picker.toString();
